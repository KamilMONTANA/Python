...
Welcome to my repository documenting my journey through the **100 Days of Code: The Complete Python Pro Bootcamp**! This repository serves as a showcase of my daily Python projects, exercises, and challenges.
...
| **13** | 🐛 **Learning Debugging** | Bug isolation, try/except handling, stack trace analysis | [View Code](./13%20Day%20Learning%20Debugging) |
| **14** | 📈 **Higher Lower (Instagram Edition)** | Dictionary iteration, program modularity, ASCII comparison | [View Code](./14%20Day%20Higher%20Lower%20Instagram%20Edition) |
...
## 🛠️ Getting Started & Running the Projects

1. **Verify you have Python installed (v3.10+ recommended):**
   ```bash
   python --version
   ```
...
2. **Clone the repository locally:**
   ```bash
   git clone https://github.com/KamilMONTANA/Python.git
   cd Python
   ```
...
*Crafted with dedication to clean code, professional architecture, and modern standards.* 🚀
